  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap">
      <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4">
        ...
        <h2 className="capitalize whitespace-nowrap truncate max-w-full text-lg sm:text-2xl flex-1 md:text-center">
      ...
      <div className="flex flex-col">
        ...
        <p className="text-capitalize">{exercise.muscles.join("&")}</p>
      </div>
